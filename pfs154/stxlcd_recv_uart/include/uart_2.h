/* ------------------------------------------------------
  ...
  #define uart_puts_enable  0                // 0 : nicht verfuegbar
                                             // 1 : verfuegbar

  #define transmit_enable   0                // Sendenfunktion einbinden / nicht einbinden
  #define receive_enable    1                // Emfpangsfunktion einbinden / nicht einbinden

  #define uart_txbit        PA6              // Anschlusspin der TX-Leitung
  #define uart_rxbit        PA4              // Anschlusspin der RX-Leitung
...
//  #define uart_delfak     6              // 57600 Bd [F_CPU== 8 MHz]
//  #define uart_delfak    22              // 19200 Bd [F_CPU== 8 MHz]
  #define uart_delfak    44               // 9600 Bd [F_CPU== 8 MHz]
