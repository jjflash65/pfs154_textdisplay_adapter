/* --------------------------------------------------------
     ...
     13.11.2018 / 28.01.2020 R. Seelig
   --------------------------------------------------------*/
...
/* --------------------------------------------------------
       Anschlusspins der Software-UART fuer ATtinyX5
   -------------------------------------------------------- */
...
/*
      #define uartsw_RXPIN   PIND
      #define uartsw_RXDDR   DDRD
      #define uartsw_RXBIT   PD3

      #define uartsw_TXPORT  PORTD
      #define uartsw_TXDDR   DDRD
      #define uartsw_TXBIT   PD2
*/
